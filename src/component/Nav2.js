...
function Nav2() {
  ...
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
    ...
    <Navbar.Brand href="/"> <img src={require('./images/logo4.png')} alt='the logo is here'  style={title}></img></Navbar.Brand>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav className="ml-auto">  
       <React.Fragment >    
            ...
            <Nav.Link href="/" className="text-warning" style={{marginRight:'15px', marginLeft:'0px' ,paddingLeft:'0px',fontSize:'20px',}} ><svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-house-door-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" href="#">
  ...
  <path fillRule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
       ...
       <React.Fragment>
        ...
        <Nav.Link href="/Menu" className="text-warning"  style={{ marginRight:'15px' ,fontSize:'20px'}}><svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-layout-text-sidebar-reverse" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fillRule="evenodd" d="M5 15V1H4v14h1zm8-11.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5z"/>
        ...
        <Nav.Link href="/OurMap" className="text-warning" style={{marginLeft:'0px',paddingLeft:'0',fontSize:'20px',marginRight:'10px'}}><svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-geo-alt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fillRule="evenodd" d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
        ...
        <Nav.Link href="/About" className="text-warning" style={{fontSize:'20px'}}><svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-info-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
