                ...
                <div className="row" style={{width:"100%"}}>
                    ...
                    <div  className="col-md-4 col-sm-12 display">
                        <h3 className="h3Footer"> Quick links</h3>
                            <ul>
                                <li className="elFooter"> <a href="#">Our Menu</a> </li>
                        ...
                        <h3 className="h3Footer"> Stay in touch</h3>
                            <ul>
                                <li className="elFooter"> 
                                    <a href="tel:95403258">
                                        <svg width="1em" height="1em" viewBox="0 0 16 16" class=" icon bi bi-telephone-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li className="elFooter"> 
                                    <svg  width="1em" height="1em" viewBox="0 0 16 16" class="icon bi bi-envelope-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
